  ...
  return (
    ...
    >
      <div className="relative w-full overflow-hidden">
        <div className="relative aspect-video w-full md:aspect-21/9 overflow-hidden">
          <Image
            ...
            quality={100}
            sizes="100vw"
            className="hidden object-cover md:block animate-ken-burns"
          />
          ...
          <Image
            ...
            quality={100}
            sizes="100vw"
            className="object-cover md:hidden animate-ken-burns"
          />
        </div>

        <div className="absolute inset-x-0 bottom-0 h-48 bg-linear-to-t from-background to-transparent md:h-64" />
      </div>
        ...
        <ScrollReveal variant="fadeUp" delay={1.2}>
          <div className="flex flex-col items-center gap-4 rounded-4xl border border-white/10 bg-background/80 p-4 shadow-2xl backdrop-blur-xl md:flex-row md:rounded-full md:px-6 md:py-4">
            <Button
              asChild
              size="lg"
              className="group h-14 rounded-full bg-brand-primary px-8 text-white! shadow-xl shadow-brand-primary/20 transition-all duration-300 hover:scale-[1.03] active:scale-[0.97]"
              aria-label={t("cta")}
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group inline-flex h-14 items-center justify-center rounded-full border border-foreground/15 px-8 text-xs font-black uppercase tracking-[0.18em] text-foreground transition-all hover:border-brand-primary hover:text-brand-primary active:scale-[0.97]"
            >
              {t("secondary_cta")}
            </a>
          </div>
